      ...
      <div class="container-box">
        <el-tabs type="border-card" class="demo-tabs">
          <el-tab-pane label="登录日志">
            <LoginLog  queryType="1"  :height="tableHeight" @waitEvent="getWaitPageChange"></LoginLog>
          </el-tab-pane>
          <el-tab-pane label="操作日志">
            <Operation queryType="1" :columns="tableColumns"  :height="tableHeight" @waitEvent="getWaitPageChange"></Operation>
          </el-tab-pane>
        </el-tabs>
      </div>
    </div>
