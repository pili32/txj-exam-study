<template>
      ...
      <div class="container-box">
        <el-tabs type="border-card" class="demo-tabs">
          <el-tab-pane label="登录日志">
            <LoginLog queryType="3"  :height="tableHeight" @waitEvent="getWaitPageChange"></LoginLog>
          </el-tab-pane>
          <el-tab-pane label="操作日志">
            <Operation queryType="3" :columns="tableColumns"   :height="tableHeight" @waitEvent="getWaitPageChange"></Operation>
  ...
  watchEffect(() => {
    if (myDiv.value) {
      tableHeight.value = myDiv.value.clientHeight - 180; // 获取高度并响应式更新
    }
  });
