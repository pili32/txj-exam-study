        ...
        <div v-if="examShow">
          ...
          >
            ...
            <div v-if="currentQuestion.type == 2">
              ...
              >
                <div class="box-group">
                  <el-checkbox :label="children.value" border>
          ...
          >
            <div>
              ...
              <span>{{ filterAnalysis(currentQuestion.sourceCode) }} </span>
            </div>
        ...
        <div v-else class="container-box-center">
          <div class="container-content">
            ...
            <div class="container-item">
              ...
              <div class="container-item">
                <div class="item-type">题目所属文件</div>
                <el-select
