<template>
  <div class="layout-box" :style="{ height: height + 100 + 'px' }">
    <div class="layout-center">
      <header>
        <el-button type="primary" @click="submitFile()" v-if="formReadlony">保存</el-button>
...
import { examSave, examQueryById, examUpdate } from "@/api/examination";
